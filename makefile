...
EXP=0
RUN_ARGS=./dataset/mapping_rule ./dataset/dblp_new.table ./dataset/dblp_new.table --exp_version=$(EXP) --max_base_table_size=1000000 --max_query_table_size=100000 --index_version=1 
